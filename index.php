...
<div class="row footer">
  <div class="legal">
    <div class="col-md-3 box">
      <a href="#" data-toggle="modal" data-target="#login" style="color:lightyellow"><b></b>Admin Login</a>
    </div>
    <div class="col-md-3 box">
      <p style="color:lightyellow">Organized by Byrut Business Solutions</p>
    </div>
    <div class="col-md-2 box">
      <a href="feedback.php" style="color:lightyellow;" target="new">Feedback</a>
    </div>
  </div>
