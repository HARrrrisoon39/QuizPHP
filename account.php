...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <title>Byrut Business Solutions</title>
    ...
    <div class="header">
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6">
                <span class="logo">Byrutsolutions</span>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-6" style="float:right">
                ...
                if (!(isset($_SESSION['username']))) {
                    ...
                    echo '
                    <span class="pull-right top title1" style="color:white;">
                        <span class="glyphicon glyphicon-user" aria-hidden="true">
                        ' . $username . '&nbsp;|&nbsp;
                        </span>
                        <span class="glyphicon glyphicon-log-out" aria-hidden="true">                        
                            <span class="log log1" style="margin-left:-4px;">
...
if (@$_GET['q'] == 1) {
    ...
    echo '<div class="panel" style="overflow-x: scroll;"><table class="table table-striped title1"  style="vertical-align:middle;">
...
if (@$_GET['q'] == 'result' && @$_GET['eid']) {
    ...
    if ($status == "finished") {
        echo '<div class="panel" style="overflow-x: scroll;">
...
if (@$_GET['q'] == 2) {
    ...
    echo '<div class="panel title"  style="overflow-x: scroll;">
...
<tr><td style="vertical-align:middle"><b>Rank</b></td><td style="vertical-align:middle"><b>Name</b></td><td style="vertical-align:middle"><b>Branch</b></td><td style="vertical-align:middle"><b>Username</b></td><td style="vertical-align:middle"><b>Score</b></td></tr>';
    ...
    echo '</table></div>';
    echo '<div class="panel title" style="overflow-x: scroll;"><table class="table table-striped title1" ><tr>';
...
<a href="#" data-toggle="modal" data-target="#developers" s style="color:lightyellow;" onmouseover="this.style('color:yellow')" target="new">Organized by Byrut Business Solutions</a>
</div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" style="font-family:'typo' "><span style="color:orange">Byrut Business Solutions</span></h4>
      </div>
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/bg2.jpg" width=100 height=100 alt="Mugunthan" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="" style="color:#202020; font-family:'typo' ; font-size:18px" title="">Byrutsolutions</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 xxxxxxxxxx</h4>
		<h4 style="font-family:'typo' ">xxxxxxxx@gmail.com</h4>
		<h4 style="font-family:'typo' ">xxxxxxxxx</h4></div></div>
		</p>
      </div>
...
<a href="feedback.php" style="color:lightyellow;text-decoration:none" onmouseover="this.style('color:yellow')" target="new">Feedback</a></div>
